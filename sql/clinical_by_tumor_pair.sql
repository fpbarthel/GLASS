...
SELECT
	...
	tumor_barcode_a,
	tumor_barcode_b,
	--s1.surgery_location AS surgery_location_a,
	--s2.surgery_location AS surgery_location_b,
	--s1.surgery_laterality AS surgery_laterality_a,
	--s2.surgery_laterality AS surgery_laterality_b,
	--r1.grade_int AS grade_a,
	--r2.grade_int AS grade_b,
	(CASE
...
LEFT JOIN analysis.mutation_freq mf1 ON mf1.aliquot_barcode = tp.tumor_barcode_a
LEFT JOIN analysis.mutation_freq mf2 ON mf2.aliquot_barcode = tp.tumor_barcode_b