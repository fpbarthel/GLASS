SELECT
    ...
    snv_driver_count::integer,
    cnv_driver_count::integer,
    snv_driver_count_shared::integer,
    cnv_driver_count_shared::integer,
    snv_driver_count_private_a::integer,
    cnv_driver_count_private_a::integer,
    snv_driver_count_private_b::integer,
    cnv_driver_count_private_b::integer,
    snv_driver_shared,
    cnv_driver_shared,
