SELECT 
	...
	(CASE WHEN pl1.cellular_prevalence >= 0.5 THEN 'C' WHEN pl1.cellular_prevalence >= 0.1 AND pl1.cellular_prevalence < 0.5 THEN 'S' END) AS clonality_a,
	pl2.cellular_prevalence AS cellular_prevalence_b, 
	pl2.variant_allele_frequency AS variant_allele_frequency_b, 
	(CASE WHEN pl2.cellular_prevalence >= 0.5 THEN 'C' WHEN pl2.cellular_prevalence >= 0.1 AND pl2.cellular_prevalence < 0.5 THEN 'S' END) AS clonality_b,
